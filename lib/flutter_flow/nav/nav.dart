...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const SignuploginWidget() : const CoverPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => const ReservationinfoWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'coverPage',
          path: '/coverPage',
          builder: (context, params) => const CoverPageWidget(),
        ),
        FFRoute(
          name: 'MyReservation1',
          path: '/myReservation1',
        ...
        FFRoute(
          ...
          builder: (context, params) => const ReservationsPageWidget(),
        ),
        FFRoute(
          name: 'MyReservation',
          path: '/myReservation',
        ...
        FFRoute(
          ...
          path: '/myReservationHistory',
          builder: (context, params) => const MyReservationHistoryWidget(),
        ),
        FFRoute(
          name: 'Profile-final',
          path: '/profileFinal',
